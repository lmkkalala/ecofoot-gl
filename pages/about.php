    ...
    <div class="container tm-mt-60" style="margin-top:-4%;">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">
                ECOLE DE FOOT GOD IS MY LIGHT
            </h2>
        </div>
        <div class="row tm-mb-74 tm-row-1640">            
            <div class="col-lg-5 col-md-6 col-12 mb-3">
                <img src="<?=base_url('img/Logo ECOFOOOT/logo ECOFOOT.jpg')?>" alt="Image" class="img-fluid">
            </div>
            <div class="col-lg-7 col-md-6 col-12">
                <div class="tm-about-img-text">
                <h2 class="tm-text-primary mb-4">Qui sommes nous?</h2>
                <p class="mb-4">
        ...
        <div class="row tm-mb-50">
            <div class="col-md-4 col-12">
                <div class="tm-about-3-col">
                    ...
                    <h2 class="tm-text-primary mb-4">Ce que nous faisons?</h2>
            ...
            <div class="col-md-4 col-12">
                <div class="tm-about-3-col">
                    ...
                    <h2 class="tm-text-primary mb-4">Les meilleurs joueurs.</h2>
            ...
            <div class="col-md-4 col-12">
                <div class="tm-about-3-col">
                    ...
                    <h2 class="tm-text-primary mb-4">Pourquoi nous?</h2>
